...
class _MenuMudanzaScreenState extends State<MenuMudanzaScreen> {
      ...
      body: mudanza == null
          ...
          : Column(
              children: [
                ...
                Text(
                  '${mudanza!.direccionOrigen} - ${mudanza!.direccionDestino}'.toUpperCase(),
                  style: const TextStyle(
                    fontSize: 12,
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        _crearOpcio(Icons.inventory_2_outlined, 'Inventory', () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>
                                  InventarioScreen(idMudanza: widget.idMudanza),
                            ),
                          );
                        }),
                        _crearOpcio(Icons.settings_outlined, 'Settings', () {}),
                        _crearOpcio(Icons.sticky_note_2_outlined, 'Notes', () {}),
                        _crearOpcio(Icons.recycling_outlined, 'Recycle', () {}),
                        _crearOpcio(Icons.timeline, 'Timeline', () {}),
                        _crearOpcio(Icons.delete_outline, 'Delete', _confirmarBorradoMudanza),
                      ],
                    ),
                  ),
                ),
  ...
  Future<void> _confirmarBorradoMudanza() async {
    ...
    if (confirm == true) {
      final db = await DatabaseService.getDatabase();
      await db.mudanzaDao.eliminarPorId(widget.idMudanza);
