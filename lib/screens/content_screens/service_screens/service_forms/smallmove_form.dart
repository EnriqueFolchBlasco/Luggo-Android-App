...
class SmallMoveForm extends StatelessWidget {
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          LuggoTextField(controller: pickupController, hint: 'moveFromHint'.tr()),

          LuggoLabel('dropoffAddress'.tr()),
          LuggoTextField(controller: dropoffController, hint: 'moveToHint'.tr()),

          LuggoLabel('details'.tr()),
          LuggoTextField(
